...
image_folder = r'C:\Users\jdiaz\Desktop\DTU_ExperimentCognitiveScience\images'  # Update with your image folder path
...
with open('results_ID_' + str(participant_id) + 'con' + str(condition) + ".txt", 'w') as f:
